 ...
 */
public record UserLicense(DiveType diveType, String orgName, RoleLevel roleLevel, Integer licenseLevel, String licenseImgUrl,
						  Boolean confirmTF,
						  Long confirmAdminId) {

	public static UserLicense fromJpaEntity(UserLicenseJpaEntity userLicenseJpaEntity) {
		return new UserLicense(userLicenseJpaEntity.getDiveType(), userLicenseJpaEntity.getOrgName(),
			userLicenseJpaEntity.getRole(), userLicenseJpaEntity.getLicenseLevel(),
