...
@Getter
public class GetHomeActiveBuddyEventCommand extends SelfValidating<GetHomeActiveBuddyEventCommand> {
	...
	@Builder
	public GetHomeActiveBuddyEventCommand(LocalDateTime eventStartDate, int pageNumber, int pageSize) {
