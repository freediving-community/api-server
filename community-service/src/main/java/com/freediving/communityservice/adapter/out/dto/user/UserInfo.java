...
public class UserInfo {
	...
	public UserInfo(Long userId, String nickname, String profileImgUrl, MemberLicenseInfo memberLicenseInfo) {
		this.userId = userId;
		...
		this.memberLicenseInfo = MemberLicenseInfo.builder()
			.freeDiving(new FreeDiving(f.getRoleLevel(), f.getRoleLevelCode(), f.getLicenseLevel(), null,
				f.getLicenseValidTF()))
			.scubaDiving(new ScubaDiving(s.getRoleLevel(), s.getRoleLevelCode(), s.getLicenseLevel(), null,
				s.getLicenseValidTF()))
			.build();
	}
